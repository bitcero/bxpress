...
<head>
    <title><?php _e('New Reply!', 'bxpress'); ?></title>
...
<div class="wrapper" style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #fbfbfb; text-align: center;">
    ...
    <table class="centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto">
        ...
        <tr>
            <td><h1 style="margin: 0; font-size: 30px; font-weight: bold; text-transform: uppercase;"><?php echo $xoopsConfig['sitename']; ?></h1></td>
        </tr>
        <tr>
            <td height="30">&nbsp;</td>
        </tr>
                            ...
                            <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                                ...
                                <tr>
                                    <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
                                        ...
                                        <h1 style="Margin-top: 0;color: #565656;font-weight: 700;font-size: 36px;Margin-bottom: 18px;font-family: sans-serif;line-height: 42px"><?php _e('New Reply!', 'bxpress'); ?></h1>
                                        <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">
                                            <?php echo sprintf(__('A new reply has been sent in topic %s from forum %s:', 'bxpress'), '<strong>' . $topic->title() . '</strong>', '<strong>' . $forum->name() . '</strong>'); ?>
                                        </p>
                                        ...
                                        <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 24px">
                                            <?php echo sprintf(__('Click here to %s in %s', 'bxpress'), '<strong><a href="' . $post->permalink() . '">' . __('view the message', 'bxpress') . '</a></strong>',
                    ...
                    <tr>
                        <td class="column" style="padding: 0;vertical-align: top;text-align: left">
                            ...
                            <p style="text-align:center;Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 24px;margin-left:30px;margin-right:30px;">
                                <?php _e('You are receiving this message because you are subscribed to our forum notifications.', 'bxpress'); ?>
                            </p>

                            <p style="text-align:center;Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 24px;margin-left:30px;margin-right:30px;">
                                <strong><a href="<?php echo $unsubscribe_link; ?>"><?php _e('Unsubscribe', 'bxpress'); ?></a> | <a href="<?php echo $account_link; ?>"><?php _e('Your Account', 'bxpress'); ?></a></strong>
                            </p>
