...
switch ($op) {
    ...
    case 'delete':
        ...
        $files = rmc_server_var($_POST, 'files', []);
    ...
    default:
        ...
        $form->addElement(new RMFormEditor(__('Post', 'bxpress'), 'msg', '90%', '300px', 'tiny' == $rmc_config['editor_type'] ? $post->getVar('post_text', 'e') : $post->getVar('post_text', 'e')), true);
