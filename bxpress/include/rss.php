...
function &exmbb_rssfeed($limit, &$more)
{
    ...
    require_once XOOPS_ROOT_PATH . '/modules/exmbb/class/bbforum.class.php';
...
function &exmbb_rssshow($limit)
{
    ...
    require_once XOOPS_ROOT_PATH . '/modules/exmbb/class/bbforum.class.php';
    require_once XOOPS_ROOT_PATH . '/modules/exmbb/class/bbpost.class.php';

    foreach ($_GET as $k => $v) {
        $$k = $v;
    }

    $feed = [];		// Información General
    $ret = [];
