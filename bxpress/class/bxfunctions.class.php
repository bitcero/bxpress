...
class bXFunctions
{
    ...
    public static function forumList($varname = 'forums', $assign = true)
    {
        ...
        while (false !== ($row = $db->fetchArray($result))) {
            ...
            $forums[] = ['id' => $forum->id(), 'title' => $forum->name()];
        }
     ...
     * @return array
     */
    public static function loadAnnouncements($w, $forum = 0)
    {
        ...
        while (false !== ($row = $db->fetchArray($result))) {
            ...
            $an->assignVars($row);
            $tpl->append('announcements', ['text' => $an->text('s')]);
        }
     ...
     */
    public static function include_js_language()
    {
        global $rmTpl;
