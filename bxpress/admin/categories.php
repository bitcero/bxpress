...
function showForm($edit = 0)
{
    ...
    $form->addElement(new RMFormGroups(__('Groups', 'bxpress'), 'groups', 1, 1, 4, $edit ? $catego->groups() : [0]), true, 'checked');
...
function bxpress_save_category($edit = 0)
{
    ...
    $catego->setGroups(!isset($groups) || is_array($groups) ? [0] : $groups);
...
function activeCatego($act = 0)
{
    ...
    $cats = RMHttpRequest::request('ids', 'array', []);
